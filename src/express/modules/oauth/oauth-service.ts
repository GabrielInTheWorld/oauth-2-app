...
import { Constructable, Inject, Factory } from '../../../application/model-layer/core/modules/decorators';
import { Random } from '../../../application/util/helper';
import { OAuthHandler } from './oauth-handler';
import { Ticket } from '../../../application/model-layer/core/models/ticket';
...
@Constructable(OAuthHandler)
export class OAuthService implements OAuthHandler {
  ...
  public async generateToken(req: express.Request, res: express.Response): Promise<void> {
    ...
    if (req.body.client_id) {
      ...
      if (code) {
        ...
        const ticket = (await this.ticketHandler.create(user)).result as Ticket;
