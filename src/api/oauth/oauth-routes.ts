...
export class OAuthRoutes {
  ...
  public initRoutes(): void {
    ...
    this.app.post('/callback', (request, response) => this.oauthHandler.callback(request, response));
    this.app.get('/callback', (request, response) => this.oauthHandler.callback(request, response));
  }
}
